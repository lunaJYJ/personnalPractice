...
var DECREASE = 'DECREASE'; //액션 생성함수.(액션객체를 만들어주는 함수)
...
var store = (0, _redux.createStore)(reducer); //state를 사용한 기본적인 렌더링.
...
render(); //render 가 store를 구독하는 상태로 만들어 줌

store.subscribe(render); //이벤트 발생 = dispatch(액션생성함수)
